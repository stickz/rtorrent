...
public:
  ...
  static const uint8_t read_message_size = 2 * 5;
  ...
  static const uint16_t buffer_size = enc_pad_read_size + 20 + enc_negotiation_size + enc_pad_size + 2 + handshake_size + read_message_size;
